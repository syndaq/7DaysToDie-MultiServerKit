...
namespace SdtdMultiServerKit.WebApi.Controllers
{
    ...
    public class ItemIconsController : ApiController
    {
        ...
        /// </summary>
        /// <remarks>
        /// e.g. /api/ItemIcons/airConditioner__00FF00.png Can
        /// </remarks>
        /// <param name="name">May be an icon name or item name, Suffix must be set when using an icon name.png Can, </param>
        /// <returns></returns>
        [HttpGet]

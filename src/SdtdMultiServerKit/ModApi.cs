...
using SdtdMultiServerKit.Hooks;
using SdtdMultiServerKit.Triggers;
    ...
    public class ModApi : IModApi
    {
        ...
        public void InitMod(Mod modInstance)
        {
            try
            {
                ...
                MonoFrameworkAssemblyLoader.Register(modInstance.Path);
        ...
        private static void StartupWebSocket()
        {
            try
            {
                ...
                if (_webSocketServer.IsListening)
                {
                    ...
                    CustomLogger.Info("SdtdMultiServerKit Web Socket Server listening on port " + webSocketPort);
                }
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Registercontroller、Function、Database repository related types
        /// </summary>
